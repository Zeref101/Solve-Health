...
export default function StudentDashboard() {
  return (
    <div>
      <div className="py-4 min-h-screen bg-[#0A171E] w-full text-white flex flex-col gap-4">
        ...
        <div className="quote h-40 bg-[#41515B] mx-6 rounded-2xl flex">
          ...
          <div className="flex flex-col m-2 my-4 gap-2 basis-1/2 w-full">
            ...
            <div>
              <button className="h-full w-full bg-[#20E9C1] rounded-xl text-black py-2 text-lg font-bold shadow-custom">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="search  mx-6 shadow-custom rounded-3xl">
          <div className="search-bar">
            <input
              type="text"
              className="w-full h-14 bg-contain bg-no-repeat bg-right bg-[#172935] border-2 bg-search border-[#172935] placeholder:text-white placeholder:font-bold rounded-3xl p-4 text-white"
              placeholder="Search"
            />
          </div>
        </div>
